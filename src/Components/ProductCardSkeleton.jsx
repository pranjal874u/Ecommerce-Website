...
const ProductCardSkeleton = () => {
  ...
  const light = "flex justify-evenly itmes-center min-h-screen w-screen flex-wrap z-10";
  const dark = "flex bg-gray-500 justify-evenly items-center w-screen flex-wrap z-10";
  return (
